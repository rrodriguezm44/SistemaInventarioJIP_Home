...
@section('content_header')
    ...
    <nav aria-label="breadcrumb" style="font-size: 18pt;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Listado de Productos Comprados</li>
        </ol>
    </nav>
@stop
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary" href="{{ url('admin/compras/create') }}">Nueva Compra</a>
                    </div>
                    <!-- /.card-tools -->
                </div>
                <!-- /.card-header -->
