...
@section('content_header')
    ...
    <nav aria-label="breadcrumb" style="font-size: 18pt;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daots de la Categorias</li>
        </ol>
    </nav>
@stop
            ...
            <div class="card card-info">
                ...
                <div class="card-body" style="display: block;">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        readonly value="{{ $categoria->nombre }}">
                                    </div>
                                    @error('nombre')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="{{ url('admin/categorias') }}" class="btn btn-danger">Volver</a>
                                </div>
                            </div>
                        </div>
