...
@section('content_header')
    ...
    <nav aria-label="breadcrumb" style="font-size: 18pt;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Actualizacion de datos de Producto</li>
        </ol>
    </nav>
@stop
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="text" value="{{ old('precio_compra', $producto->precio_compra) }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="text" value="{{ old('precio_venta', $producto->precio_venta) }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="text" value="{{ old('stock_minimo', $producto->stock_minimo) }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="text" value="{{ old('stock_maximo', $producto->stock_maximo) }}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="unidad_medida" id="unidad_medida" class="form-control">
                                                    ...
                                                    <option value="uni" {{ $producto->unidad_medida == "uni" ? 'selected' : '' }}>Unidad</option>
                                                    ...
                                                    <option value="pqt"  {{ $producto->unidad_medida == "pqt" ? 'selected' : '' }}>Paquete</option>
                                                    <option value="eqi" {{ $producto->unidad_medida == "eqi" ? 'selected' : '' }}>Equipo</option>
                                                </select>
                                            </div>
                                            @error('unidad_medida')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control" name="estado" id="estado" required>
                                                    ...
                                                    <option value="1" {{ old('estado',$producto->estado) == '1' ? 'selected' : '' }}>Disponible
                                                    </option>
                                                    <option value="0" {{ old('estado',$producto->estado) == '0' ? 'selected' : '' }}>No Disponible
                                                    </option>   
                                                </select>
                                            </div>
                                            @error('estado')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                             ...
                                             <br><br><br>
                                                    <img id="imgPreview" src="{{ asset('storage/' . $producto->imagen) }}" alt="Vista previa del aimagen" width="100%">
                                                    <script>
